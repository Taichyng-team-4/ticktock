...
const getActivityInformation = async () => {
    try {
        ...
        // 更新活動列表
        console.log(activityInformation.value);
...
<template>
    <div class="" v-if="activityInformation">
        ...
        <main class="p-4 sm:p-6">
                ...
                <div class="p-5 flex">
                    <div class="self-center">
                        ...
                        <p class="flex items-center" v-else>
                            <span class="material-icons mr-3"> access_time_filled </span>{{activityInformation.startAt}}-{{activityInformation.endAt}}
                        </p>
            ...
            <div class="flex flex-col md:flex-row gap-8 mt-3">
                <table class="table-auto w-full text-left border border-gray30 rounded-l-lg">
                    ...
                    <tbody>
                        <tr class="border-t border-gray30" v-for="(ticketTypeItem) in activityInformation.ticketTypes" :key="ticketTypeItem.id">
                            ...
                            <td class="px-4 py-2 w-1/4">
                                <div class="flex items-center justify-center">
                                    <button class="border border-gray-500 px-2 py-1 bg-gray-200" data-action="decrement">
                                        -
                                    </button>
                                    <input type="number" class="quantity border border-gray-500 text-center w-16 py-1 price"
                                        min="0" value="0" />
                                    <button class="border border-gray-500 px-2 py-1 bg-gray-200" data-action="increment">
                                        +
                                    </button>
                                </div>
                            </td>
