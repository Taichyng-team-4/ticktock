    ...
    <div class="container mx-auto px-6 py-2" v-if="!isLogin">
      <div class="mx-auto px-4 max-w-7xl flex justify-between items-center">
        <div class="flex items-center">
          <div>
            <a href="/" class="text-gray50 text-xl font-bold cursor-pointer hover:text-gray50"
              >Ticktock</a
            >
          </div>
        </div>
        ...
        <div>
          <div class="hidden md:block">
            <ul class="flex space-x-4 text-nav items-center">
              <li>
                <a href="/login" class="text-gray50/70 font-bold hover:text-gray50">登入</a>
              </li>
              <li>
                <a href="/register" class="text-gray50/70 font-bold hover:text-gray50">註冊</a>
              </li>
            </ul>
          </div>
        ...
        <div>
          <div class="hidden md:block">
            <ul class="flex space-x-4 text-nav items-center">
              <li>
                <a
                  href="/personal_center/userOrder"
                  class="text-gray50/70 font-bold hover:text-gray50"
                  >訂單查詢</a
                >
              </li>
              <!-- <li>
              ...
              <div class="dropdown">
                <button class="dropbtn flex items-center">
                  <span class="material-icons text-gray50/70 font-bold hover:text-gray50">
                    account_circle
                  </span>
                </button>
                <div class="dropdown-content">
